...
| [`techy::core`](crate::core) | machinery hub: language contract, state, engine | [`Lang`](crate::core::Lang), [`ParsingState`](crate::core::ParsingState), [`ParsingStateDelta`](crate::core::ParsingStateDelta), [`Language`](crate::core::Language), [`ParseDriver`](crate::core::ParseDriver), [`ParseResult`](crate::core::ParseResult), [`TrivialLang`](crate::core::TrivialLang) |
| [`techy::core::token`](crate::core::token) | the tokenization library | [`Tokenization`](crate::core::token::Tokenization), [`StdTokenization`](crate::core::token::StdTokenization), [`TokenReader`](crate::core::token::TokenReader), [`StdTokenReader`](crate::core::token::StdTokenReader), [`TokenKind`](crate::core::token::TokenKind), [`TokenRules`](crate::core::token::TokenRules), [`TokenRulesOverrides`](crate::core::token::TokenRulesOverrides), [`TokenError`](crate::core::token::TokenError) |
